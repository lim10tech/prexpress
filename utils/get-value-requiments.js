            ...
            switch (_a.label) {
                case 0:
                    if (typeof data == 'string') {
                        ...
                        catch (error) { } // verninin kendisi alınıyor
                    ...
                    if (!config_data)
                        config_data = config[data_name]; // config üzerindeki gereksinimlerinin anahtarı belirtilmemiş ise ver ismi ile deneniyor
