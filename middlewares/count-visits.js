...
exports.set_config = exports.middleware = void 0;
var fs_1 = require("fs");
var selector = '.';
var visits = {};
var middleware = function (values) {
    return function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var visits_values, save_name;
            return __generator(this, function (_a) {
                if (values && values.save_visit_count) {
                    visits_values = JSON.parse("".concat((0, fs_1.readFileSync)('./db/visits.json')));
                    ...
                    (0, fs_1.writeFile)('./db/visits.json', JSON.stringify(visits_values), function () { });
                }
                else {
                    if (!visits[req.url])
                        visits[req.url] = 0;
