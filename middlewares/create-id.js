...
function create_ids(values, ids) {
    ...
    var ids = ids ? ids : {};
    return new Promise(function (resolve, reject) {
        values.syncFor(function (value, index, len, next) { return __awaiter(_this, void 0, void 0, function () {
            var id_options, id_config, key, id;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof value == 'object') {
                            id_options = value;
                            id_config = __values_req[value.data_name];
                            for (key in id_config) {
                                if (!value[key]) {
                                    id_options[key] = id_config[key];
                                }
                            }
                        }
                        return [4 /*yield*/, makeid(id_options)];
                    case 1:
                        id = _a.sent();
...
var middleware = function (values) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, create_ids(values, res.ids)];
                case 1:
                    ids = _a.sent();
                    res.ids = ids;
                    next();
